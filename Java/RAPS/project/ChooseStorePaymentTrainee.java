...
public class ChooseStorePaymentTrainee extends JFrame
{
	private final int VISA = 0;
			...
			protected ChooseStorePaymentTrainee choosePage;
			protected ItemList newItems;
			public ChooseStorePaymentTrainee( ItemList itemList, String finalP,
				String ID, int s )
			{
				super( "Choose Method of Payment-PRACTICE");
				...
				submit.addActionListener(
					...
					new ActionListener()
					{
						public void actionPerformed( ActionEvent e )
						{
							...
							if( flag )
							{
								JOptionPane.showMessageDialog( null, "You have completed" +									" this training excercise.\nThank You." );
								choosePage.hide();
							}
						}
					}
