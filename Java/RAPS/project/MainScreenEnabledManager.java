...
public class MainScreenEnabledManager extends JFrame implements ActionListener
{
	...
	protected JMenu 	fileMenu, accountMenu, aboutMenu, checkoutMenu, 
						returnMenu, reportMenu, orderMenu, partMenu;
		
	protected JMenuItem	aboutItem, exitItem, logoffItem,
						checkoutItem, returnItem, 
						reportPartItem, reportEmployeeItem, 
						requestItem, 
						customerAccountItem, hireEmployeeItem,
						addPartItem, removePartItem;
		
	protected JMenuBar 	bar;
	
	protected AboutPage aboutPage;
	protected BrowsePage browsePage;
	protected RemovePartPage removePart;
	protected Manager myManager;
	protected MainScreenEnabledManager thisPage;
	protected ItemList itemList;
	protected String addSku;
	protected int quantity;
	public MainScreenEnabledManager( RetrieveEmployeeID manager )
	{
		super("Welcome to RAPS-Manager Enabled");
		thisPage = this;
		myManager = new Manager( manager );
		...
		JMenu partMenu = new JMenu( "Parts" );
		...
		JMenuItem updateAccountItem = new JMenuItem( "Update Employee Accounts" );
		updateAccountItem.setMnemonic( 'u' );
		accountMenu.add( updateAccountItem );
			
		JMenuItem hireEmployeeItem = new JMenuItem( "Hire Employee" );
		hireEmployeeItem.setMnemonic( 'h' );
		accountMenu.add( hireEmployeeItem );
		...
		JMenuItem requestItem = 
			new JMenuItem( "Part Request Form" );
		...
		addPartItem.setMnemonic( 't' );
		partMenu.add( addPartItem );
			
		JMenuItem removePartItem = new JMenuItem( "Remove Part" );
		removePartItem.setMnemonic( 'm' );
		partMenu.add( removePartItem );
		...
		JMenuItem addExistingPart = new JMenuItem( "Add to Existing Part" );
		partMenu.add( addExistingPart );
		
		JMenuItem viewDailyBalance = new JMenuItem( "Daily Balance" );
		reportMenu.add( viewDailyBalance );
		...
		orderItem.addActionListener(
			...
			new ActionListener()
			{
				public void actionPerformed( ActionEvent event )
				{
					OrderPage orderPage = new OrderPage(myManager.storeNumber,
						myManager.login );
				}
			}
		);
		...
		removePartItem.addActionListener(
			...
			new ActionListener()
			{
				public void actionPerformed( ActionEvent event )
				{
					String sku = null, qString = null;
					try
					{
						sku = JOptionPane.showInputDialog( 
					...
					removePart = new RemovePartPage( sku, qString, 
						myManager.storeNumber );
				...
				public void actionPerformed( ActionEvent event )
				{
					...
					else
					{
						new ChooseStorePayment( itemList, Double.toString(itemList.total),
							myManager.login, myManager.storeNumber );
					}
				}
			}
		);
		addListItem.addActionListener(
			...
			new ActionListener()
			{
				public void actionPerformed( ActionEvent event )
				{
					new AddPartToList( itemList, myManager.storeNumber );
				}
			}
		);
		returnItem.addActionListener(
			...
			new ActionListener()
			{
				public void actionPerformed( ActionEvent e )
				{
					...
					new ReturnPart( orderNumber, myManager.storeNumber, quantity );
		...
		hireEmployeeItem.addActionListener(
			
			new ActionListener()
			{
				public void actionPerformed( ActionEvent event )
				{
					HireEmployeePage hire = new HireEmployeePage( myManager );
				}
			}
		);
		updateAccountItem.addActionListener(
			...
			new ActionListener()
			{
				public void actionPerformed( ActionEvent event )
				{
					...
					new UpdateEmployeePage( empID, myManager );
				}
			}
		);
		addPartItem.addActionListener(
			...
			new ActionListener()
			{
					public void actionPerformed( ActionEvent event )
					{
						new AddPart( myManager.storeNumber);
					}
			}
		);
		...
		viewInventoryItem.addActionListener(
			...
			new ActionListener()
			{
				public void actionPerformed( ActionEvent e )
				{
					new ViewParts( myManager.storeNumber );
				}
			}
		);
		addExistingPart.addActionListener(
			...
			new ActionListener()
			{
				public void actionPerformed( ActionEvent e )
				{
					...
					{
						addSku = 
							JOptionPane.showInputDialog( "Please enter SKU: " );
					}
					...
					{
						String addQuantity = 
							JOptionPane.showInputDialog( "Please enter a valid quantity" );
							
						quantity = Integer.parseInt( addQuantity );
					...
					new AddExistingPart( addSku, quantity, myManager.storeNumber );
				}
			}
		);
		viewDailyBalance.addActionListener(
		
			new ActionListener()
			{
				public void actionPerformed( ActionEvent e )
				{
					new ViewDailyBalance( myManager.storeNumber );
				}
			}
		);
		mainPane.validate();
